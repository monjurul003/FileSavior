...
import mik.encryption.StringEncryptorDecryptor;
...
//			byte[] contentInBytes = content.getBytes();
     ...
     * stream********************************************
     */
    public byte[] readImageAsByteStream(String fileLocation, String fileName) {
        try {
...
//			System.out.println("file : " + temp);
    ...
    public List<User> prepareSystem() {
        ...
        boolean firstLaunch = this.checkApplicationsFirstLaunchOrNot();
