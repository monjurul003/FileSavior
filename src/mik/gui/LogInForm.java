...
public class LogInForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanelLogIn.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Log In", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Cambria", 1, 14), new java.awt.Color(0, 0, 204))); // NOI18N
        ...
        btnLogIn.setBounds(120, 180, 90, 30);
        ...
        lblCreateAcc.setForeground(new java.awt.Color(0, 0, 204));
    ...
    private void btnLogInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogInActionPerformed
        ...
        for (int i = 0; i < this.userList.size(); i++) {
            System.out.println("name--" + this.userList.get(i).getUserName() + "pass--" + this.userList.get(i).getPassword());
            if (this.userList.get(i).getUserName().equals(userName) && this.userList.get(i).getPassword().equals(password)) {
//                    System.out.println("Log in done");
    ...
    private void txtNameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNameKeyPressed
        // TODO add your handling code here:
        if (this.txtName.getText().length() >= 16) {
            String str = this.txtName.getText().substring(0, 16);
    ...
    private void jPasswordKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jPasswordKeyTyped
        // TODO add your handling code here:
        if (this.jPassword.getPassword().length >= 16) {
            char[] pass = this.jPassword.getPassword();
